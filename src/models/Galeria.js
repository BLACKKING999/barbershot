...
class Galeria {
  ...
  static async buscar(termino, limite = 20) {
    ...
    try {
      const [rows] = await pool.execute(query, [busquedaParam, busquedaParam, limite]);
      return rows;
    } catch (error) {
  ...
  static async obtenerPorEmpleado(empleado_id, opciones = {}) {
    ...
    try {
      const [rows] = await pool.execute(query, [empleado_id, activo, limite]);
      return rows;
    } catch (error) {
  ...
  static async obtenerPorServicio(servicio_id, opciones = {}) {
    ...
    try {
      const [rows] = await pool.execute(query, [servicio_id, activo, limite]);
      return rows;
    } catch (error) {
  ...
  static async obtenerElementos(galeria_id, opciones = {}) {
    ...
    try {
      const [rows] = await pool.execute(query, [galeria_id]);
      return rows;
    } catch (error) {
  ...
  static async removerElemento(galeria_id, multimedia_id) {
    ...
    try {
      const [result] = await pool.execute(query, [galeria_id, multimedia_id]);
      return result.affectedRows > 0;
    } catch (error) {
